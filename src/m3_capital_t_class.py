...
class CapitalT(object):
    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def clone(self):
        ...
        capT.h_rect.outline_color = self.h_rect.outline_color
        capT.v_rect.outline_color = self.v_rect.outline_color
        capT.h_rect.fill_color = self.h_rect.fill_color
        capT.v_rect.fill_color = self.v_rect.fill_color
        return(capT)
